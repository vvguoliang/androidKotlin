 ...
 */
class FragmentBasic_Syntax : BaseFragemt() {

    var viewpager: ViewPager_Adapter? = null
    var listfra: List<Fragment>? = null

    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val rootView = inflater?.inflate(R.layout.fra_basicsyntax, container, false)
        init(rootView!!)
...
//state的状态有三个，0表示什么都没做，1正在滑动，2滑动完毕
        ...
        listfra = mutableListOf(VPFragementBS1(), VPFragementBS2())
